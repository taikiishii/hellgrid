...
(() => {
  ...
  const REWARD2 = {
    ...
    // 初回 (-0.01 / -0.02) は弱すぎて挙動がほぼ動かなかった (射撃率 38→33%、
    // 完走も改善なし)。エントロピーボーナスに勝てる強さまで引き上げた第2版
    missedShot: -0.03,    // 誰にも当てなかったステップの消費弾1発あたり (ammoSpent に上乗せ)
    weaponSwitch: -0.05,  // 武器切替1回 (無目的な切替の抑制)
