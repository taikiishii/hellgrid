...
document.addEventListener('keyup', e => {
  if (curWorld) curWorld.keys[e.code] = false;
});
...
function advance() {
  curWorld.nextLevel();
  if (curWorld.state === 'playing') canvas.requestPointerLock();
}
