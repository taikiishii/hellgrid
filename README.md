...
タイトル画面で **I キー**を押すと、強化学習(PPO)で学習したAIが自動でプレイします
(プレイ中に I を押すと、その場でAIに交代/操作を取り戻せます)。
...
現在のAIは**全5ステージを平均9.2秒でクリア**します。ただし敵はほとんど倒しません
(倒すより走り抜けるほうが報酬が高いと学習したため)。詳しくは
[docs/machine-learning.md](docs/machine-learning.md) を参照。
